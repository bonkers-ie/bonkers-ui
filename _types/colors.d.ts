...
export declare const colorClasses: {
    ...
    "--color-primary-alt-300": string;
    "--color-primary-alt-400": string;
    "--color-primary-alt-500": string;
    "--color-primary-alt-600": string;
    "--color-primary-alt-700": string;
    ...
    "--color-secondary-alt": string;
    "--color-secondary-alt-200": string;
    "--color-secondary-alt-300": string;
    "--color-secondary-alt-400": string;
    "--color-secondary-alt-500": string;
    "--color-secondary-alt-600": string;
    "--color-secondary-alt-700": string;
    "--color-error": string;
    ...
    "--color-accent-alt": string;
    "--color-accent-alt-300": string;
    "--color-accent-alt-400": string;
    "--color-accent-alt-500": string;
    "--color-accent-alt-600": string;
    "--color-accent-alt-700": string;
};
