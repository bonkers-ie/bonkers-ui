import{j as e}from"./jsx-runtime-u17CrQMm.js";import{E as a,U as c,a as o}from"./UiAccordionItem.base-CTUxfD4v.js";import"./iframe-BxDd88Ne.js";import{U as d,E as l}from"./UiIcon-CG_1QLJA.js";import{c as m}from"./index-eWKFQ63B.js";import{U as t,E as x,a as g}from"./UiTypography-KWBVqKeR.js";import{E as s}from"./colors-C6mSASMA.js";import"./preload-helper-PPVm8Dsz.js";const T={title:"Components/UiAccordion",component:c,argTypes:{defaultValue:{description:"The array of values to be opened by default, must match the id of the accordion item",control:{type:"text"}},type:{options:[a.SINGLE,a.MULTI],description:"The type of accordion, single open or multiple open at once",control:{type:"radio"}},handleTrigger:{description:"The function to be called when an accordion item is clicked"},children:{description:"The child content of the accordion"}},args:{defaultValue:[],type:a.SINGLE,children:"Content",handleTrigger:r=>{console.log(`Item: ${r}`)}}},i={render:r=>e.jsxs(c,{className:"col-auto flex flex-col justify-start gap-xs",...r,children:[e.jsxs(o,{className:"overflow-hidden rounded-sm bg-secondary-alt-200",id:"section1",children:[e.jsx(o.Trigger,{className:"flex flex-row items-center justify-between px-sm py-xs",children:p=>e.jsxs(e.Fragment,{children:[e.jsx(t,{color:s.PRIMARY,children:"Item"}),e.jsx("div",{className:m("transition","text-primary-700",p?"rotate-180":"rotate-0"),children:e.jsx(d,{name:["far","face-smile"],size:l.XS})})]})}),e.jsx(o.Content,{children:e.jsx(t,{className:"bg-secondary-alt-300 p-md",color:s.SECONDARY,children:"Content for Item"})})]}),e.jsxs(o,{id:"section2",children:[e.jsx(o.Trigger,{children:"Unstyled Item"}),e.jsx(o.Content,{children:"Content for Unstyled Item"})]})]})},n={render:()=>e.jsx(c,{children:e.jsxs(o,{id:"user-image",children:[e.jsx(o.Trigger,{className:"rounded-md bg-secondary-alt-200 px-xs py-xxs",children:r=>e.jsxs("div",{className:"flex flex-row items-center gap-sm",children:[e.jsx("div",{className:"max-h-xxxl max-w-xxxl overflow-hidden rounded-full bg-secondary-alt-400",children:e.jsx("img",{src:"https://i.pravatar.cc?img=12",alt:"avatar"})}),e.jsxs("div",{className:"grid w-full",children:[e.jsx(t,{lineHeight:!0,weight:x.SEMI_BOLD,color:s.SECONDARY_500,children:"Ms Jane Doe"}),e.jsx(t,{lineHeight:!0,size:g.SM,color:s.SECONDARY_400,children:"jane.doe@bonkers.ie"})]}),e.jsx("div",{className:m("mr-sm h-fit text-secondary-500 transition",r?"rotate-180":""),children:e.jsx(d,{name:["fas","chevron-down"],size:l.SM})})]})}),e.jsx(o.Content,{className:"px-sm py-xs",children:"Content"})]})})};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: args => {
...
}`,...n.parameters?.docs?.source}}};const N=["Basic","Details"];export{i as Basic,n as Details,N as __namedExportsOrder,T as default};
