import{j as e}from"./jsx-runtime-u17CrQMm.js";import"./iframe-CQUZaMRG.js";import{c as f}from"./index-CDBE95Q4.js";import{U as g,a as T}from"./UiPills-BHYvr3nb.js";import{U as c,E as m,d as p,a as b,b as x}from"./UiTypography-CQjCqBxz.js";import{U as n,E as o}from"./UiIcon-DWACRY73.js";import"./preload-helper-PPVm8Dsz.js";const s=({badgeText:r,title:a,subtitle:l,header:u,className:h})=>e.jsxs("div",{className:f("relative flex flex-col gap-sm rounded-2xl border border-secondary-alt-500 bg-white","px-xs py-sm",h),children:[r&&e.jsx("div",{className:"absolute -top-xxs right-xs",children:e.jsx(g,{rounded:!0,kind:T.ACCENT_ALT,children:r})}),u,e.jsxs("div",{className:"grid gap-xxs",children:[e.jsx(c,{size:x.MD,weight:b.BOLD,align:p.LEFT,color:m.SECONDARY,lineHeight:!0,children:a}),e.jsx(c,{size:x.XS,align:p.LEFT,color:m.SECONDARY_400,lineHeight:!0,children:l})]})]});s.__docgenInfo={description:"",methods:[],displayName:"UiProductCard",props:{badgeText:{required:!1,tsType:{name:"string"},description:""},title:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},subtitle:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},header:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const z={title:"Components/UiProductCard",component:s,argTypes:{title:{control:{type:"text"},description:"The title text"},subtitle:{control:{type:"text"},description:"The subtitle text"},header:{description:"The element to display in the header area of the card"},badgeText:{description:"The text or component displayed in the badge"}},args:{title:"This is a Title",subtitle:"This is a Subtitle",badgeText:"",header:null}},t={render:r=>{const a=e.jsx("div",{className:"flex w-fit rounded-full bg-primary p-sm text-white",children:e.jsx(n,{name:["far","face-smile"],size:o.LG})});return e.jsx(s,{...r,header:a})}},i={render:r=>{const a=e.jsx("div",{className:"flex w-fit rounded-full bg-primary p-sm text-white",children:e.jsx(n,{name:["far","face-angry"],size:o.MD})}),l=e.jsx("div",{className:"flex w-fit rounded-full bg-primary p-xxs text-white",children:e.jsx(n,{name:["far","face-meh"],size:o.LG})});return e.jsxs("div",{className:"grid w-[412px] grid-cols-2 gap-xs",children:[e.jsx(s,{...r,header:a}),e.jsx(s,{...r,header:l,badgeText:"UP TO €586 OFF"})]})}},d={args:{title:"This is a Titleajhs",subtitle:"This is a Subtitle uablobv",badgeText:"",header:null},render:r=>{const a=e.jsx("div",{className:"flex w-fit rounded-full bg-primary p-sm text-white",children:e.jsx(n,{name:["far","face-smile"],size:o.LG})});return e.jsx(s,{...r,header:a})}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: args => {
...
}`,...d.parameters?.docs?.source}}};const R=["Default","Variants","Test1"];export{t as Default,d as Test1,i as Variants,R as __namedExportsOrder,z as default};
