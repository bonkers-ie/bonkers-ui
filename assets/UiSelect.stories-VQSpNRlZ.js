import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{R as o}from"./index-DmM0KDA7.js";import{c as C}from"./index-C7T3p30y.js";import{U as m,b as h,E as j}from"./UiTypography-BZRJyQsk.js";const T="_UiSelect_1fbno_1",R={UiSelect:T},c=({children:t,heading:a,subLabel:r,disabled:s,onChange:n,className:b,placeholder:d,postfixIcon:p,...i})=>{const[y,f]=o.useState(i.value||i.defaultValue||""),S=o.useCallback(u=>{f(u.target.value),n==null||n(u)},[n]);return e.jsxs("div",{className:b,children:[a?e.jsx(m,{size:h.MD,className:"mb-xxs",children:a}):null,e.jsxs("div",{className:C(R.UiSelect,"relative","rounded-xl","border","hover:border-secondary-alt-700",s?["pointer-events-none","border-secondary-alt-300","bg-secondary-alt-200"]:["border-secondary-alt-500","bg-white"]),children:[e.jsxs("select",{...i,className:`m-0
					w-full
					cursor-pointer
					appearance-none
					border-0
