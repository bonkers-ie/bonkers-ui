...
}`,...(S=(j=m.parameters)==null?void 0:j.docs)==null?void 0:S.source}}};var R,V,N;c.parameters={...c.parameters,docs:{...(R=c.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: args => {
    const [value, setValue] = React.useState(args.value);
    const handleChange = (val: number) => {
      setValue(val);
...
}`,...(N=(V=c.parameters)==null?void 0:V.docs)==null?void 0:N.source}}};var w,I,M;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    disabled: true
  }
}`,...(M=(I=p.parameters)==null?void 0:I.docs)==null?void 0:M.source}}};const J=["Default","NegativeRange","DecimalSteps","Disabled"];export{c as DecimalSteps,d as Default,p as Disabled,m as NegativeRange,J as __namedExportsOrder,G as default};
