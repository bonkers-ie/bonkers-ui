import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{E as a,U as c,a as o}from"./UiAccordionItem.base-BAhn-Z3x.js";import"./iframe-Bu0IX4pq.js";import{U as h,E as y}from"./UiIcon-KDCi0Awl.js";import{c as f}from"./index-DzVpbrLG.js";import{U as s,E as t,a as u,b as I}from"./UiTypography-Bq0rQqh9.js";const v={title:"Components/UiAccordion",component:c,argTypes:{defaultValue:{description:"The array of values to be opened by default, must match the id of the accordion item",control:{type:"text"}},type:{options:[a.SINGLE,a.MULTI],description:"The type of accordion, single open or multiple open at once",control:{type:"radio"}},handleTrigger:{description:"The function to be called when an accordion item is clicked"},children:{description:"The child content of the accordion"}},args:{defaultValue:[],type:a.SINGLE,children:"Content",handleTrigger:r=>{console.log(`Item: ${r}`)}}},i={render:r=>e.jsxs(c,{className:"col-auto flex flex-col justify-start gap-xs",...r,children:[e.jsxs(o,{className:"overflow-hidden rounded-sm bg-secondary-alt-200",id:"section1",children:[e.jsx(o.Trigger,{className:"flex flex-row items-center justify-between px-sm py-xs",children:U=>e.jsxs(e.Fragment,{children:[e.jsx(s,{color:t.PRIMARY,children:"Item"}),e.jsx("div",{className:f("transition","text-primary-700",U?"rotate-180":"rotate-0"),children:e.jsx(h,{name:["far","face-smile"],size:y.XS})})]})}),e.jsx(o.Content,{children:e.jsx(s,{className:"bg-secondary-alt-300 p-md",color:t.SECONDARY,children:"Content for Item"})})]}),e.jsxs(o,{id:"section2",children:[e.jsx(o.Trigger,{children:"Unstyled Item"}),e.jsx(o.Content,{children:"Content for Unstyled Item"})]})]})},n={render:()=>e.jsx(c,{children:e.jsxs(o,{id:"user-image",children:[e.jsx(o.Trigger,{className:"rounded-md bg-secondary-alt-200 px-xs py-xxs",children:r=>e.jsxs("div",{className:"flex flex-row items-center gap-sm",children:[e.jsx("div",{className:"max-h-xxxl max-w-xxxl overflow-hidden rounded-full bg-secondary-alt-400",children:e.jsx("img",{src:"https://i.pravatar.cc?img=12",alt:"avatar"})}),e.jsxs("div",{className:"grid w-full",children:[e.jsx(s,{lineHeight:!0,weight:u.SEMI_BOLD,color:t.SECONDARY_500,children:"Ms Jane Doe"}),e.jsx(s,{lineHeight:!0,size:I.SM,color:t.SECONDARY_400,children:"jane.doe@bonkers.ie"})]}),e.jsx("div",{className:f("transition h-fit mr-sm text-secondary-500",r?"rotate-180":""),children:e.jsx(h,{name:["fas","chevron-down"],size:y.SM})})]})}),e.jsx(o.Content,{className:"px-sm py-xs",children:"Content"})]})})};var d,l,m;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: args => {
...
}`,...(g=(x=n.parameters)==null?void 0:x.docs)==null?void 0:g.source}}};const S=["Basic","Details"];export{i as Basic,n as Details,S as __namedExportsOrder,v as default};
